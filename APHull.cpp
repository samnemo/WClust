...
// Downloaded from http://geomalgorithms.com/a11-_hull-2.html on 2/17/2015
//
...
//    APPoint with coordinates {float x, y;}
//===================================================================
...
inline float
isLeft( APPoint& P0, APPoint& P1, APPoint& P2 )
{
...
int nearHull_2D( APPoint* P, int n, int k, APPoint* H )
{
    ...
    APPoint* cP;                  // the current point being considered
