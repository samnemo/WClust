...
namespace amp
{
    ...
    public:
        ...
        campf& operator= (const char *s)         { x=v; y=0; return *this; }
        campf& operator= (const std::string &s)  { x=v; y=0; return *this; }
    ...
    {
        ampf<Precision> t = z.x*z.y; return campf(sqr(z.x)-sqr(z.y), t+t); 
    }
